...
<ul>
  <li> coffee.py was where i started with learning python. </li>
<li> coffee2.py will display how much more i've learned and had fun playing around with the code. </li>
